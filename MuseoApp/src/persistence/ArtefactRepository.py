...
class ArtefactRepository:
    ...
    # Requerimiento 4, con filtro de id de artefacto 
    ...
    # Requerimiento 4, con filtro de rango de fechas
    ...
    # Requerimiento 4, con filtro de rango de fechas y id de artefacto
